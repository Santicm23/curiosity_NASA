...
class Sistema {
    ...
    public:
        ...
        //* obtener la ruta más larga entre dos elementos de interés
        pair<list<Elemento*>, float> ruta_mas_larga_elem(Elemento* elem);

        pair<list<int>, float> ruta_mas_larga_elems_recur(int id1, int id2, list<int> visitados);
